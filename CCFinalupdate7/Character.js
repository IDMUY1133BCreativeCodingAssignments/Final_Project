...
function Character() {
 ...
 //   myAnimation1.offY = 18;
  ...
  this.walking = function() {
    ...
    if(ghost.position.x >= 1400 || ghost.position.x < 100) { // if the apple is past a certain position on the screen it will delete and strawberry will win the game
      ghost.velocity.y = 5;
      textSize(72);
      fill(203, 13, 0);
    ...
    if (straw.position.x <100 || straw.position.x > 1400) { // will remove the strawberry if passes x=100
      straw.velocity.y = 5;
      textSize(72);
      fill(0, 187, 39);
